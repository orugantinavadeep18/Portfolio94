...
import portfolio from "../assets/portfolio.jpg"; // Replace with your portfolio screenshot
      ...
      <div className="w-full text-gray-900">
        ...
        >
          ...
          >
            ...
            <p className="mt-4 text-base md:text-lg opacity-90">
              Showcase your work with a stunning portfolio that highlights your skills, projects, and personal brand.
            </p>
          </motion.div>
        ...
        <section className="px-4 md:px-16 py-12 md:py-16 bg-white text-gray-900">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start mb-16 md:mb-20">
            <div>
              ...
              <p className="text-base md:text-lg leading-relaxed">
                A modern portfolio should visually impress while being fast and responsive. I build portfolios that perfectly showcase your work, skills, and projects across all devices.
              </p>
            </div>
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <p className="font-semibold text-lg md:text-xl">Portfolio Development</p>
              </div>
              <div>
          ...
          >
            ...
            <p className="text-base md:text-lg leading-relaxed">
              Portfolios must balance aesthetics and performance. I focused on responsive design, device adaptability, and fast loading to ensure a seamless user experience.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="absolute text-[80px] md:text-[180px] font-extrabold text-gray-100 z-0">GOALS</div>
          ...
          >
            ...
            <p className="text-base md:text-lg mb-6 md:mb-8 leading-relaxed">
              Development followed sprints focusing on design, responsive layout, and device testing for optimal performance.
            </p>
            <div className="relative bg-white shadow-xl rounded-xl p-4 md:p-6">
              <div className="flex flex-col gap-4 md:gap-6">
                <div className="flex flex-col md:flex-row md:items-center">
                  ...
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700">4-5 days</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="w-full md:w-60 h-10 bg-pink-500 rounded-lg flex items-center justify-center text-white">Development</div>
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700">5-6 days</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="w-full md:w-48 h-10 bg-orange-500 rounded-lg flex items-center justify-center text-white">Testing</div>
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700">2-3 days</span>
                </div>
              </div>
            </div>
          </motion.div>
