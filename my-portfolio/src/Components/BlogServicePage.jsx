  ...
  return (
    ...
    >
      <div className="w-full text-gray-900">
        {/* ================= HERO ================= */}
        <section
          className="relative bg-gradient-to-br from-pink-600 via-red-500 to-orange-400 text-white py-16 px-6 md:py-20 md:px-8 text-center md:text-left flex flex-col lg:flex-row items-center lg:items-start justify-between rounded-b-[40px] md:rounded-b-[60px] shadow-2xl gap-10"
        >
          {/* Back Button */}
          <a
            href="/"
          ...
          >
            ...
            <p className="mt-4 text-base md:text-lg opacity-90">
              Build a professional blog with engaging UI, smooth CMS, and SEO-ready structure.
            </p>
          </motion.div>

          {/* Device Showcase (Desktop/Laptop/Phone same as Ecommerce) */}
          {/* ... reuse your showcase & Swiper here (same code as EcommerceServicePage) */}{/* Device Showcase */}
        ...
        <section className="px-4 md:px-16 py-12 md:py-16 bg-white text-gray-900">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start mb-16 md:mb-20">
            <div>
              ...
              <p className="text-base md:text-lg leading-relaxed">
                A modern blog must go beyond just posting articles. I deliver fast, user-friendly, and SEO-optimized blogging platforms that allow content creators to focus on storytelling while the tech runs smoothly behind the scenes.
              </p>
            </div>
            <div className="space-y-6 md:space-y-8">
              <div>
                ...
                <p className="font-semibold text-lg md:text-xl">CMS & Blog Development</p>
              </div>
              <div>
                <h4 className="text-gray-500 text-base md:text-lg">Duration of Development</h4>
                <p className="font-semibold text-lg md:text-xl">2 – 3 weeks</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-base md:text-lg leading-relaxed">
              The biggest challenge with blogs is scalability and performance. A blog must load fast, handle large traffic, and remain SEO-optimized. My focus was to ensure content organization, category/tagging, and fast search functionality.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 relative z-10">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-4 text-base md:text-lg">SEO Optimization</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-r from-orange-400 to-yellow-500"></div>
                <p className="mt-4 text-base md:text-lg">Content Management</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-r from-purple-400 to-pink-500"></div>
                <p className="mt-4 text-base md:text-lg">Scalable Design</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-base md:text-lg mb-6 md:mb-8 leading-relaxed">
              The blog was built in sprints focusing on design, SEO setup, and CMS integration with strong testing cycles.
            </p>
            <div className="relative bg-white shadow-xl rounded-xl p-4 md:p-6">
              <div className="flex flex-col gap-4 md:gap-6">
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="w-full md:w-40 h-10 bg-pink-500 rounded-lg flex items-center justify-center text-white">Design</div>
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700"> 5 days</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="w-full md:w-60 h-10 bg-orange-500 rounded-lg flex items-center justify-center text-white">Development</div>
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700">5-6  days</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center">
                  <div className="w-full md:w-48 h-10 bg-green-500 rounded-lg flex items-center justify-center text-white">Testing</div>
                  <span className="mt-2 md:mt-0 md:ml-4 text-gray-700">3-4 days</span>
                </div>
              </div>
            </div>
          </motion.div>
